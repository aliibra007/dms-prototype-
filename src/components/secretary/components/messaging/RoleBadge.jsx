...
const ROLE_COLORS = {
  Doctor: { light: '#7C3AED', dark: '#A78BFA' }, // Purple
  Patient: { light: '#0EA5E9', dark: '#38BDF8' }, // Sky blue (Secretary primary)
  Secretary: { light: '#10B981', dark: '#34D399' }, // Green (Secretary accent)
};
